...
######################################################################
socket_escucha.bind((INTERFACES,PUERTO))
######################################################################
print("Ok.")
...
while True:
    ...
    ######################################################################
    socket_datos, direccion_remota = socket_escucha.accept()
    ######################################################################
    ...
    while bytes_leidos==TAMANIO_BUFFER:
        ...
        # Leemos los mensajes
        ######################################################################
        bytes = socket_datos.recv(TAMANIO_BUFFER)
        ######################################################################
    ...
    ######################################################################
    socket_datos.send(buffer_envio)
    ######################################################################
