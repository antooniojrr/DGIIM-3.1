...
// DNI: 77432800B
// Compilado con: g++ -std=c++11 -pthread -o prodcons1_su prodcons1_su.cpp scd.cpp
...
constexpr int
   ...
   num_cons = 3   ;
int
   siguiente_dato[num_prod]={0}   ; // siguiente valor a devolver en 'producir_dato'
...
int producir_dato( int i )
{
   ...
   const int valor_producido = siguiente_dato[i] + ( i * (num_items/num_prod) ) ;
   siguiente_dato[i] ++ ;
   mtx.lock();
...
void funcion_hebra_productora( MRef<ProdConsMu> monitor, int id )
{
