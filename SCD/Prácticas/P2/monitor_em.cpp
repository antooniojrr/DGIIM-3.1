...
// DNI: 77432800B
// Compilado con: g++ -std=c++11 -pthread -o monitor_em monitor_em.cpp scd.cpp
// -----------------------------------------------------------------------------
//
...
void test_1()
{
   ...
   duration<float,milli> duracion = fin - inicio;
   ...
   cout << "Ha tardado " << duracion.count() << " milisegundos" << endl;
}
// *****************************************************************************
